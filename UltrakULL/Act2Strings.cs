...
namespace UltrakULL
{
    public static class Act2Strings
    {
        ...
        public static string level42(string message, string message2, string input, JsonParser language)
        {
        ...
        public static string level43(string message, string message2, string input, JsonParser language)
        {
            string fullMessage = message + message2;
            a2StringsLogger.LogInfo(fullMessage);
        ...
        public static string level44(string message, string message2, string input, JsonParser language)
        {
            string fullMessage = message + message2;
        ...
        public static string level4secret(string message, string message2, string input, JsonParser language)
        {
            string fullMessage = message + message2;
            if (fullMessage.Contains("HOLD"))
            {
        ...
        public static string level51(string message, string message2, string input, JsonParser language)
        {
            string fullMessage = message + message2;
        ...
        public static string level52(string message, string message2, string input, JsonParser language)
        {
            string fullMessage = message + message2;
        ...
        public static string level53(string message, string message2, string input, JsonParser language)
        {
            string fullMessage = message + message2;
        ...
        public static string level54(string message, string message2, string input, JsonParser language)
        {
            string fullMessage = message + message2;
        ...
        public static string level5secret(string message, string message2, string input, JsonParser language)
        {
            return "Unknown 5-S string";
        }

        public static string level61(string message, string message2, string input, JsonParser language)
        {
            return "Unknown 6-1 string";
        }

        public static string level62(string message, string message2, string input, JsonParser language)
        {
        ...
        public static string getMessage(string message, string message2, string input,JsonParser language)
        {
            ...
            switch (currentLevel)
            {
                ...
                case "Level 4-2":
                    {
                        return level42(message, message2, input,language);
                    }
                case "Level 4-3":
                    {
                        return level43(message, message2, input,language);
                    }
                case "Level 4-4":
                    {
                        return level44(message, message2, input,language);
                    }
                case "Level 4-S":
                    {
                        return level4secret(message, message2, input, language);
                    }
                case "Level 5-1":
                    {
                        return level51(message, message2, input,language);
                    }
                case "Level 5-2":
                    {
                        return level52(message, message2, input, language);
                    }
                case "Level 5-3":
                    {
                        return level53(message, message2, input, language);
                    }
                case "Level 5-4":
                    {
                        return level54(message, message2, input, language);
                    }
                case "Level 5-S":
                    {
                        return level5secret(message, message2, input, language);
                    }
                case "Level 6-1":
                    {
                        return level61(message, message2, input, language);
                    }
                case "Level 6-2":
                    {
                        return level62(message, message2, input, language);
                    }
