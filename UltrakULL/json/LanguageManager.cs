...
namespace UltrakULL.json
{
    public static class LanguageManager
    {
        ...
        public static void InitializeManager(string modVersion)
        {
            ...
            configFile = new ConfigFile("BepInEx" + Path.DirectorySeparatorChar + "config" + Path.DirectorySeparatorChar + "ultrakull" + Path.DirectorySeparatorChar + "lastLang.cfg", true);
        ...
        public static void LoadLanguages(string modVersion)
        {
            ...
            string[] files = Directory.GetFiles(Path.Combine(Directory.GetCurrentDirectory() + Path.DirectorySeparatorChar + "BepInEx" + Path.DirectorySeparatorChar + "config" + Path.DirectorySeparatorChar, "UltrakULL"), "*.json");
        ...
        public static void SetCurrentLanguage(string langName)
        {
            ...
            if (allLanguages.ContainsKey(langName))
            {
                ...
                AudioSwapper.speechFolder = Directory.GetCurrentDirectory() +  Path.DirectorySeparatorChar + "BepInEx" + Path.DirectorySeparatorChar + "config" + Path.DirectorySeparatorChar + "ultrakull" + Path.DirectorySeparatorChar + "audio" + LanguageManager.CurrentLanguage.metadata
