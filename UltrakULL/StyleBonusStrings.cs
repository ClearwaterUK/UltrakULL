    ...
    public static class StyleBonusStrings
    {
        ...
        public static string GetStyleBonusDictionary(string inputBonus)
        {
            switch(inputBonus)
            {
                ...
                case "ultrakill.catapulted": { return "<color=#00ffff>" + LanguageManager.CurrentLanguage.style.style_catapulted + "</color>"; }
                ...
                case "ultrakill.fireworksweak": { return "<color=#00ffff>" + LanguageManager.CurrentLanguage.style.style_fireworksweak + "</color>"; }
